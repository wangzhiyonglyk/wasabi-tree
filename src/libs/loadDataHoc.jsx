...
const loadDataHoc = function (Widget, componentType = "select") {
    class loadDataHocCompnent extends React.Component {
        ...
        handlerData() {
            if (this.state.loadDataStatus === "url") {
                ...
                let formatData =formatterData(componentType, this.getValue(), this.state.rawData, idOrValueField, this.props.textField || "text");
                this.setState({
                    data: formatData,
     ...
     */
        ...
        loadSuccess(res) {//数据加载成功
            ...
            let formatData =formatterData(componentType, this.getValue(), realData, idOrValueField, this.props.textField);
             this.setState({
                loadDataStatus: null,
